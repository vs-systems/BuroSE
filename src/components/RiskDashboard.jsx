...
const RiskDashboard = ({ theme, setTheme }) => {
    ...
    return (
        <div id="risk-search" className="min-h-screen bg-slate-900 text-slate-100 font-sans selection:bg-blue-500/30">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
                                BuroSE <span className="text-blue-500 text-sm font-normal">Premium</span>
                            </h1>
                        </div>
                    </div>
                    <button
                        onClick={handleLogout}
                        className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors text-sm font-medium px-4 py-2 rounded-lg hover:bg-slate-800 border border-transparent hover:border-slate-700"
                    >
