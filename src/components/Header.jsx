                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <button
                            ...
                            className="text-sm font-medium text-brand-neon hover:opacity-80 transition-colors"
                        >
                            Consultar Riesgo
                        </button>
                    ...
                    <div className={`md:hidden py-4 border-t animate-in slide-in-from-top duration-300 rounded-b-2xl shadow-xl ${theme === 'dark' ? 'border-brand-card bg-brand-dark/95 backdrop-blur-xl' : 'border-slate-100 bg-white/95 backdrop-blur-xl'
                        ...
                        <div className="flex flex-col space-y-2 px-4">
                            ...
                            <button
                                ...
                                className="px-4 py-3 text-left text-brand-neon font-bold hover:bg-brand-neon/5 rounded-xl transition-colors"
                            >
                                Consultar Riesgo
                            </button>
