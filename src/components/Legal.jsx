        ...
        replica: {
            ...
            content: (
                <>
                    ...
                    <p className="mt-6 text-xs bg-brand-dark p-3 border border-white/10 rounded italic">
            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-16 px-4">
                    <div className="inline-flex items-center space-x-2 bg-brand-neon/10 border border-brand-neon/20 px-4 py-2 rounded-full mb-6">
                        ...
                        <span className="text-brand-neon text-xs font-bold uppercase tracking-widest">Compromiso Legal</span>
                    </div>
                    <h2 className="text-4xl font-bold text-white mb-6">Validación por Expertos Jurídicos</h2>
                    ...
                    <p className="mt-4 text-brand-neon font-medium">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        className="bg-brand-card border border-brand-secondary p-8 rounded-2xl hover:border-brand-neon/40 hover:bg-brand-card/80 transition-all cursor-pointer group"
                    >
                        ...
                        <span className="text-brand-neon text-xs font-bold uppercase border-b border-brand-neon/30 pb-1 group-hover:border-brand-neon transition-all">Ver Documento</span>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-sm text-brand-muted mb-6">
                            Información sobre el tratamiento de datos según la Ley 25.326 y plazos de conservación (Derecho al Olvido).
                        </p>
                        <span className="text-brand-neon text-xs font-bold uppercase border-b border-brand-neon/30 pb-1 group-hover:border-brand-neon transition-all">Ver Política</span>
                    </div>

                    {/* Card 3: Réplica */}
                    <div
                        onClick={() => openModal(docs.replica.title, docs.replica.content)}
                        className="bg-brand-card border border-brand-secondary p-8 rounded-2xl hover:border-brand-neon/40 hover:bg-brand-card/80 transition-all cursor-pointer group text-brand-alert/90 border-brand-alert/10"
                    >
                        <AlertCircle className="text-brand-neon mb-4 group-hover:scale-110 transition-transform" size={40} />
                        <h3 className="text-xl font-bold text-white mb-3">Derecho a Réplica</h3>
                        <p className="text-sm text-brand-muted mb-6">
                            Procedimiento formal de Habeas Data para rectificación o supresión de datos erróneos.
                        </p>
                        <span className="text-brand-neon text-xs font-bold uppercase border-b border-brand-neon/30 pb-1 group-hover:border-brand-neon transition-all">Ver Procedimiento</span>
                    </div>
                </div>
            </div>
